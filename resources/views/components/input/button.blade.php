...
<button
  ...
  >
    <svg wire:loading {{ $attributes->whereDoesntStartWith('wire:click') }} class="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
