        ...
        <div class="flex items-center justify-between">
          <div class="w-8/12 mb-4 md:flex md:justify-between">
              <div class="w-full mb-4 md:mr-2 md:mb-0">
                <input wire:model.lazy='long_url' class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border shadow appearance-none focus:outline-none focus:shadow-outline @error('long_url') border-red-500 @enderror" id="long_url" type="text" placeholder="Long URL (required)" />
                <p class="text-red-500">@error('long_url'){{ $message }}@enderror</p>
              </div>
              <div class="w-full md:ml-2">
                <input wire:model.lazy='description' class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border shadow appearance-none focus:outline-none focus:shadow-outline @error('description') border-red-500 @enderror" id="description" type="text" placeholder="Short URL keyword (optional)" />
                <p class="text-red-500">@error('description'){{ $message }}@enderror</p>
              </div>
              <label class="inline-flex items-center md:ml-4">
                <input type="checkbox" class="w-5 h-5 text-gray-600 form-checkbox">
                <span class="ml-2 text-gray-700">Private?</span>
              </label>
            </div>
          <div class="mb-6 text-center">
              <button class="inline-flex items-center justify-center w-full px-10 py-2 text-white transition duration-150 ease-in-out bg-blue-600 hover:bg-blue-800 focus:outline-none focus:shadow-outline focus:border-blue-800 focus:shadow-outline-blue active:bg-blue-800 disabled:opacity-50" type="submit"><svg wire:loading wire:target="" class="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
